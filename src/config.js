...
const config = {
    ...
    VITE_LOGIN_API: SETTINGS.VITE_LOGIN_API || SETTINGS.VITE_WALLET_API_BASE,
    VITE_VEGAS_HOME_URL: SETTINGS.VITE_VEGAS_HOME_URL,
    ...
    CASINO_OPEN_STYLE: SETTINGS.CASINO_OPEN_STYLE,
};
