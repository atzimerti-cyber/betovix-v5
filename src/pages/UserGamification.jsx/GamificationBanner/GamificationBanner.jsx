              ...
              <div className={classes.HeroContainer}>
                <div className={classes.HeroName}>
                  <p className={classes.DescTitle}>
                    {translate(
                      hero.metadata.HeroName + " " + hero.metadata.HeroSubName
                    )}
                  </p>
                </div>
                <div
                  className={classes.HeroImg}
                  onClick={() => handleBannerClick(hero)}
                >
                  <img
                    src={hero.cropped}
                    loading="lazy"
                    alt={<LoaderPlaceholder />}
                  />
                </div>
                <div className={classes.HeroLevelsContainer}>
                  <div className={classes.HeroLevels}>
                    <Levels
                      displayedHero={hero}
                      activeLevel={activeLevel ? activeLevel : hero.levels[0]}
            ...
            <div className={classes.BannerBackground}>
              <div className={classes.HeroContainer}>
                <div
                  ...
                  style={{ height: "218px", marginTop: "15px" }}
                >
                  <LoaderPlaceholder />
                </div>
