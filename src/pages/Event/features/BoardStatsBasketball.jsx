            ...
            <div className={classes.StatSection}>
                ...
                <div className={classes.Content}>
                    <div className={classes.ContentRow}>
                        <FlashingScore score={scores.current.home.ht} previousScore={scores.previous.home.ht} withEmptyDash />
                    </div>
                    <div className={classes.ContentRow}>
                        <FlashingScore score={scores.current.away.ht} previousScore={scores.previous.away.ht} withEmptyDash />
                    </div>
                </div>
            </div>
