    ...
    <>
      <div className={classes.StatSection}>
        ...
        <div className={classes.Content}>
          <div className={classes.ContentRow}>
            <FlashingScore
              score={props.event?.Header.CornersHome}
              previousScore={props.event?.PreviousHeader?.CornersHome}
            />
          </div>
          <p>-</p>
          <div className={classes.ContentRow}>
            <FlashingScore
              score={props.event?.Header.CornersAway}
              previousScore={props.event?.PreviousHeader?.CornersAway}
            />
          </div>
        </div>
      </div>
      ...
      <div className={classes.StatSection}>
        ...
        <div className={classes.Content}>
          <div className={classes.ContentRow}>
            <FlashingScore
              score={props.event?.Header.YellowCardsHome}
              previousScore={props.event?.PreviousHeader?.YellowCardsHome}
            />
          </div>
          <p>-</p>
          <div className={classes.ContentRow}>
            <FlashingScore
              score={props.event?.Header.YellowCardsAway}
              previousScore={props.event?.PreviousHeader?.YellowCardsAway}
            />
          </div>
        </div>
      </div>
      ...
      <div className={classes.StatSection}>
        ...
        <div className={classes.Content}>
          <div className={classes.ContentRow}>
            <FlashingScore
              score={props.event?.Header.RedCardsHome}
              previousScore={props.event?.PreviousHeader?.RedCardsHome}
            />
          </div>
          <p>-</p>
          <div className={classes.ContentRow}>
            <FlashingScore
              score={props.event?.Header.RedCardsAway}
              previousScore={props.event?.PreviousHeader?.RedCardsAway}
            />
          </div>
        </div>
      </div>
