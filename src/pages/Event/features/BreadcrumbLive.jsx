...
const BreadcrumbLive = (props) => {
    ...
    useEffect(() => {
        ...
        const categories = Array.from(categoriesMap.entries()).map(([CategoryId, CategoryName]) => ({
            CategoryId,
            CategoryName,
        }));
        ...
        const fe = events.filter((t) => t.TournamentId === props.event.Info.TournamentId);
    ...
    useEffect(() => {
        ...
        const fe = allEvents.filter((e) => e.TournamentId === selectedTournament?.TournamentId);
        setFilteredEvents(fe);
        setSelectedEvent(null);
                                ...
                                {filteredEvents?.map((event) => {
                                    return (
                                        ...
                                        >
                                            <div className={classes.TeamsContainer}>
                                                <div className={classes.TeamsContainer}>
                                                    <TeamLogo teamId={event?.HomeTeamId} isHome={true} sportName={event?.SportName.International} />
                                                ...
                                                {event?.AwayTeamName?.International && (
                                                    <>
                                                        ...
                                                        <div className={classes.TeamsContainer}>
                                                            ...
                                                            <TeamLogo teamId={event?.AwayTeamId} isHome={false} sportName={event?.SportName.International} />
                                                        </div>
                                                    </>
                                                )}
                                            </div>
