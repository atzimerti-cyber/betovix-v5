...
const OutrightsMarket = (props) => {
    ...
    return (
        <div className={classes.Market}>
            <Accordion title={translateNameWithLang(props.market?.MarketName)} initOpen={true}>
                <div className={classes.MarketContainer}>
                    <div className={props.market?.MarketFields.length === 3 ? [classes.MarketGroup, classes.ThreeParts].join(' ') : classes.MarketGroup}>
