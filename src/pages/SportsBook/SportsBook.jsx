...
const SportsBook = () => {
  ...
  return (
    <div className={classes.PageContent}>
      <div className={classes.SportsBook} id="sportsbookPage">
        <div className={classes.MenuWrapper} id="sportsbookMenu">
          <SportsBookMenu />
        </div>

        <div className={classes.Content}>
          <div className={classes.SportsBookInner}>
            {!params["*"].includes("live") &&
              !params["*"].includes("outrights") && (
                <div id="sportsBanners">
                  <SportsBanners banners={sportBanners} />
                </div>
              )}
            {page}
          </div>
