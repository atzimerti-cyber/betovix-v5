...
const SportsBookMenu = () => {
  ...
  const selectedSportSlug = selectedSport
    ? `/${selectedSport.Name?.International?.toLowerCase().replace(/ /g, "-")}`
    : "";
  ...
  return (
    <SwiperMenu>
      ...
      <SwiperSlide>
        <a
          className={[classes.ModalItem].join(" ")}
          onClick={() => navigate(getModalPath("odds-format"))}
        >
          <SettingsIcon />
      ...
      <SwiperSlide>
        <a
          className={[classes.ModalItem].join(" ")}
          onClick={() => navigate(getModalPath("statistics"))}
        >
          <StatsIcon />
