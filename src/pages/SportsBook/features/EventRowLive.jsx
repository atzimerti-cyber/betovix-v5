...
const EventRowLive = (props) => {
    ...
    return event ? (
        <div className={classes.EventRow} data-event={`Event:${event.Info.MatchId}`}>
            <Link
                            ...
                            {liveStream && (
                                <PlayIcon
                                    onClick={(e) => {
                                        e.stopPropagation();
                                        e.preventDefault();
                                        dispatch(sportsbookActions.setShowVideoFor({ Info: event.Info, liveStream: liveStream }));
                                    }}
                                />
                            )}
                        </div>
            ...
            <section className={classes.Outcome}>
                ...
                <Market event={event} market={getMarket()} />
            </section>
        </div>
    ) : null;
};
