...
function HorizontalMenu(props) {
  ...
  const getName = (item) => {
    ...
    else if (item.Name.langValues[lang.id])
      return item.Name.langValues[lang.id];
            ...
            >
              {item.icon && (
                <div
                  className={
                    props.selected === item.Id
                      ? [classes.SportIcon, classes.Selected].join(" ")
                      : classes.SportIcon
                  }
                >
                  {item.icon}
              ...
              {props.withCount && item.Count && (
                <div className={classes.SportCount}>{item.Count}</div>
              )}
