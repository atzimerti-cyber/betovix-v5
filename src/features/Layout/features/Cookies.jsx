    ...
    <div className={classes.Cookies}>
      <div className={classes.Content}>
        <div className={classes.CookiesContent}>
          <p>
            {translate(
              "We use only the necessary cookies to ensure the proper functioning of our website and the safety of your browsing experience. By using our website, you agree to the use of cookies."
            )}{" "}
            <span
