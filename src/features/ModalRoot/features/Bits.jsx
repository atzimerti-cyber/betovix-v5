...
import classes from './Bits.module.css';
        ...
        <>
            ...
            <article className={classes.Card}>
                <header>
                    ...
                    <p className={classes.Title}>{translate('Daily Bits')}</p>
                </header>
                <main className={classes.CardMain}>
            ...
            <article className={classes.Card}>
                <header>
                    ...
                    <p className={classes.Title}>{translate('Weekly Bits')}</p>
                </header>
                <main className={classes.CardMain}>
            ...
            <article className={classes.Card}>
                <header>
                    ...
                    <p className={classes.Title}>{translate('Monthly Bits')}</p>
                </header>
                <main className={classes.CardMain}>
