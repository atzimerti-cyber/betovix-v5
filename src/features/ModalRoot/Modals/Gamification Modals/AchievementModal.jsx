            ...
            <SwiperSlide key={reward.Id} style={{ maxWidth: "580px" }}>
              <div className={classes.ModalContent}>
                ...
                <div className={classes.MainContent}>
                  ...
                  <div
                    className={classes.RewardDetails}
                    style={{ backgroundImage: `url(${reward.MetaData.Icon})` }}
                  >
                    ...
                    {reward.RewardName ? (
                      <>
                        <h1>
                          {reward.RewardName &&
                            reward.RewardName.split("?").map((part, index) => (
                        ...
                        <p>
                          {reward.MetaData.Description
                            ? reward.MetaData.Description.split("?").map(
                                (part, index) => (
                                  <React.Fragment key={index}>
                                    {index === 0 ? (
                                      <>{part}</>
                        ...
                        {reward.RewardName != "Level Up" && (
                          <div className={classes.ClaimButton}>
                            <MainButton
                              ...
                              onClick={() => handleClaimButton(reward.Id)}
                            >
