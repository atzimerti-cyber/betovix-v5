...
export const casinoFavoritesSlice = createSlice({
  ...
  reducers: {
    ...
    addToCasinoFavs: (state, action) => {
      state.casinoFavs[action.payload.property].Data = [
        ...state.casinoFavs[action.payload.property].Data,
        ...action.payload.values,
      ];
      state.casinoFavs[action.payload.property].filter.Page =
        state.casinoFavs[action.payload.property].filter.Page + 1;
    },
