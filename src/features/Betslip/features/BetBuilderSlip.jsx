...
import classes from "./BetBuilderSlip.module.css";
...
const BetBuilderSlip = (props) => {
  ...
  return (
    ...
    >
      <div className={classes.BBBadgeWrapper}>
        <BetBuilderBadge />
      </div>
      <div className={classes.SelectionList}>
        ...
        >
          <div className={classes.Header}>
            <div className={classes.BBTitle}>
              <div className={classes.TitleLeft}>
                <span>{translate("Bet Builder")}</span>
                <span
                  style={{
            ...
            <div className={classes.BBMatchInfo}>
