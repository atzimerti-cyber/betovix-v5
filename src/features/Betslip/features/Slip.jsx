...
const Slip = (props) => {
    ...
    const getTotalPayout = () => {
        let total = 0;
        if (amounts[props.slip.FieldId]) total = amounts[props.slip.FieldId] * props.slip.Odd;
                        ...
                        <div className={classes.TeamVersusGroup}>
                            ...
                            {props.slip.AwayTeamName?.International && (
                                <>
                                    ...
                                    <div className={[classes.TeamVersus, classes.TeamB].join(' ')}>
                                        <div className={classes.TeamText}>
                                            <div className={classes.TeamLogoWrapper}>
                                                <div className={classes.TeamLogo}>
                            ...
                            <div className={classes.OutcomeGroup}>
                                <div className={classes.Content}>
                                    <div className={classes.MarketInfo}>
                                        <div className={classes.MarketName}>{translateNameWithLang(props.slip.MarketName)}</div>
                                    </div>
                                </div>
                                <div className={classes.Extended}>
                                    <div className={classes.Content}>
                                        <div className={classes.OutcomeInfo}>
                                            <div className={classes.OutcomeName}>{getOddsLabel()}</div>
                                            <div className={classes.OddsDelta}>
                                                ...
                                                <div className={classes.Odds}>{convertOdds(props.slip.Odd)}</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            {betType === 'Single' && (
                <div className={classes.PaymentSection}>
                    ...
                    <div className={classes.PaymentMarketInfo}>
                        <div className={classes.AmountLabel}>{translate('Total Payout')}</div>
